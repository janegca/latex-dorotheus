...
\textsl{``If the \Moon\, is injured while the benefics are in the dry, earthy signs or aspect these signs, then it indicates that misfortune will barely not reach them in this journey of theirs, and if it does reach them, then it will be less than what I mentioned.''}

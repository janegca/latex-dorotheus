...
``Then \mn{1} he mentioned the condition of the \Moon\, and its corruption in which a commencement is not to be made in an action or anything when you find this until the \Moon\, and its lord is ameliorated.''
...
``If \mn{4} it is an action which its master wishes to keep secret, commence it when the \Moon\, is immersed under the \Sun's rays as there is good for him, and it will be more concealed if he commences it at the withdrawal of the \Moon\, from the \Sun\, and [its] appearance from under the rays.''
...
``He \mn{28-9} said: Look at the \Moon\, and the lord of the house in which it is and the star with which the \Moon\, conjoins and how you find the position of the \Moon\, and the star with which it conjoins and the power of these two in the cardines as these two are the indicators of this. If the \Moon\, is with two malefics in one sign and the \Moon\, is immersed between the two in this sign while the benefics aspect it from quartile, then the misfortune and misery in which men suffer at that hour they will escape from and be rid of.''

...
The diurnal signs are the Fire (\Aries, \Leo, \Sagittarius) and Air (\Gemini, \Libra, \Aquarius) signs.

The nocturnal signs are the Earth (\Taurus, \Virgo, \Capricorn) and Water (\Cancer, \Scorpio, \Pisces) signs.

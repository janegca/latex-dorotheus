...
\textsl{Straight} signs indicate slow actions but ``direct'' paths; it's clear to see where the action is leading; while \textsl{crooked} signs indicate ``quick'' actions but along an ``unclear'' or ``indirect'' path; it's not always clear where the action is leading.
\end{mdframed}

...
\textsl{``Some of them learned in the stars''} \mn{1.158} counted from the \Moon\, to the 8th and \textsl{``then cast out from \Saturn,''} and judged the native's death from the sign the lot fell in and the ruler of that sign.
...
Believe he is saying that if \Mars\ is in the 10th sign but not the 10th house (a cardine) while the \Moon\ is in a cardine, the 7th house, the native will be killed by enemies and thieves i.e. the MC might fall in the 9th sign or 11th sign, making them, rather than the 10th sign, the 'cardine' or 10th house.

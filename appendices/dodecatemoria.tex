...
The two approaches to finding the dodecatemoria, are found in Firmicus and Paulus which can both produce the same result by different means\footnotemark[1].

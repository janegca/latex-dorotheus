...
This document was built from Latex files created with the \href{https://www.tug.org/texworks/}{TexWorks} editor. The latex files for this text are freely available on \href{https://github.com/janegca/latex-dorotheus}{Github}.
...
\noindent\href{https://www.jcremers.com/}{PlanetDance Astrology Software}
	...
	A free astrology software application created by J.C. Remers. Includes a of number Hellenistic Greek techniques under Horoscope->Classical.

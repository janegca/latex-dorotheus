...
\begin{scope}[rotate=-45]
	...
	% --- draw planets
	\node         at (15:0.75) {\Sun};      
	\node         at (345:0.75) {\Mercury};  
	\node         at (235:0.75) {\Moon};    
	\node         at (40:0.75) {\Venus};   
	\node         at (160:0.75) {\Saturn};
	\node         at (170:0.75) {\Jupiter};  
	\node         at (315:0.75) {\Mars};     
	
	% -- lots
	%\pic [blue] at (45:0.55) {lot=S};
